...
const flagUserMenuSubscriptions = makeSidebarFlag(FeatureFlags.userMenuSubscriptions)
const flagUserMenuRedeem = makeSidebarFlag(FeatureFlags.userMenuRedeem)
