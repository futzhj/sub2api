<template>
  <header class="glass sticky top-0 z-30 border-b border-black/[0.06] dark:border-white/[0.08] transition-colors">
    <div class="flex h-14 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="hidden lg:block">
          <h1 class="text-base font-semibold tracking-tight text-gray-900 dark:text-white">
            {{ pageTitle }}
          </h1>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg bg-primary-500/10 px-3 py-1.5 dark:bg-primary-500/15 sm:flex border border-primary-500/15 transition-all"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-lg p-1.5 transition-colors hover:bg-black/[0.04] dark:hover:bg-white/[0.06]"
            :aria-label="t('common.userMenu')"
          >
            <div class="flex h-7 w-7 items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-primary-500 to-primary-600 text-xs font-semibold text-white shadow-sm">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
