export default {
    settings: {
      ...
      features: {
        ...
        theme: {
          title: 'Theme Color',
          description: 'Set the site brand primary color. Choose a preset or a custom hex; all users see this color in both light and dark mode.',
          preset: 'Theme preset',
          presetHint: 'Pick a preset, or choose Custom and set a primary color.',
          presets: {
            teal: 'Teal (default)',
            blue: 'Blue',
            purple: 'Purple',
          ...
          primaryColorHint: 'Used when preset is Custom. Format: #RRGGBB.',
          preview: 'Preview',
        },
        userMenu: {
