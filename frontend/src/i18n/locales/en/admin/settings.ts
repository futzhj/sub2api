export default {
    settings: {
      ...
      features: {
        ...
        theme: {
          title: 'Theme Color',
          description: 'Set the site brand primary and secondary colors. Choose a single- or dual-tone preset, or custom hexes; all users see this palette in both light and dark mode.',
          preset: 'Theme preset',
          presetHint: 'Pick a preset, or choose Custom and set primary + secondary colors.',
          presets: {
            teal: 'Teal (default)',
            blue: 'Blue',
            purple: 'Purple',
            ...
            orange: 'Orange',
            rose: 'Rose',
            barbie_neon: 'Neon Yellow · Barbie Pink',
            wasong: 'Wasong Green · Cream',
            crystal_electric: 'Crystal Purple · Electric Blue',
            tech_space: 'Tech Red · Deep Space Blue',
            burgundy_cream: 'Burgundy · Cream',
            ningye_cream: 'Ningye Purple · Cream',
            custom: 'Custom',
          },
          primaryColor: 'Custom primary color',
          primaryColorHint: 'Used when preset is Custom. Format: #RRGGBB. Primary fills buttons and strong accents.',
          secondaryColor: 'Custom secondary color',
          secondaryColorHint: 'Used when preset is Custom. Secondary drives gradients and highlights — avoid using alone as a large button fill.',
          preview: 'Preview',
        },
        userMenu: {
