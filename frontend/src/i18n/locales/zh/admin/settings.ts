export default {
    settings: {
      ...
      features: {
        ...
        theme: {
          title: '主题颜色',
          description: '设置站点品牌主色与辅色。可选单色/双色预设，或自定义主色+辅色；所有用户界面将使用该配色（深色/浅色模式均生效）。',
          preset: '主题预设',
          presetHint: '选择预设配色，或使用「自定义」并通过取色器指定主色与辅色。',
          presets: {
            teal: '青绿（默认）',
            blue: '蓝色',
            purple: '紫色',
            ...
            barbie_neon: '荧光黄·芭比粉',
            wasong: '瓦松绿·玉子',
            crystal_electric: '晶石紫·电光蓝',
            tech_space: '科技红·深空蓝',
            burgundy_cream: '勃艮第红·米白',
            ningye_cream: '凝液紫·米白',
            custom: '自定义',
          },
          primaryColor: '自定义主色',
          primaryColorHint: '仅在预设为「自定义」时生效。请使用 #RRGGBB 格式。主色用于按钮与强调填充。',
          secondaryColor: '自定义辅色',
          secondaryColorHint: '仅在预设为「自定义」时生效。辅色用于渐变、高亮与点缀，不宜单独作为大面积按钮底色。',
          preview: '预览',
        },
        userMenu: {
          title: '用户菜单显示',
